...
<div class="geo-country-form-index">
    ...
    <div class="col-md-12">
        <div class="box">
            <div class="box-header with-border">
                ...
                <div class="box-tools pull-right">
                    <span data-toggle="tooltip-country" title="" class="btn btn-box-tool" data-original-title="
                    <?= Yii::t('app', 'Таблица ‘geo_country’ страны. Содержит список стран и информацию о них.'); ?>
        ...
        <?php
        $js = <<< JS
        $('[data-toggle="tooltip-country"]').tooltip({ boundary: 'window' })
JS;
        $this->registerJs($js); ?>
    </div>
</div>
