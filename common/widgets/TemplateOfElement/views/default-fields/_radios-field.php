...
<div class="<?= $containerClass ?>">
    <?php $model->$attribute = isset($model->elements_fields[$modelFieldForm->id][$i]) ? $model->elements_fields[$modelFieldForm->id][$i] : $fieldsManage->getValue($modelFieldForm->id, $modelFieldForm->type, $model->id); ?>
    <?= $form->field($model, $attribute, [
        ...
        'name' => $modelName . "[elements_fields][$modelFieldForm->id][0]",
